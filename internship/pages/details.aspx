<%@ Page Title="Trainee Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="details.aspx.cs" Inherits="internship.pages.details" %>
                        ...
                        <div style="border: medium solid #E3F9FF; padding: inherit; margin: inherit;">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-md-offset-2">
                                        <div class="form-group">
                                            <asp:Label ID="Label2" Text="Trainee Number" runat="server" />
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-md-offset-2">
                                        <div class="form-group">
                                            <asp:Label ID="Label3" Text="Trainee Email" runat="server" />
                                            <asp:TextBox ID="traineeemail" runat="server" Enabled="true" CssClass="form-control input-sm" placeholder="Trainee Email" />
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-md-offset-2">
                                        <div class="form-group">
                                            <asp:Label ID="Label4" Text="Trainee Resume" runat="server" />
                                            <asp:TextBox ID="traineeresume" runat="server" Enabled="true" CssClass="form-control input-sm" placeholder="Put resume link here" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
